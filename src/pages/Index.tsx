...
const Index = () => {
  ...
  return (
    <Layout>
      {/* ✅ STEP 4 FIX: SEO */}
      <SEO
        title="Montessori Preschool in Thoraipakkam, Chennai | Honey Hive Montessori House"
        description="Honey Hive Montessori House is a Montessori preschool in Thoraipakkam, Chennai offering Playgroup, Pre-KG, LKG & UKG in a safe, joyful and child-led learning environment."
        canonical="/"
      />

      {/* ✅ STEP 4 FIX: JSON-LD Schema (Preschool + WebSite) */}
      <Helmet>
          ...
          {JSON.stringify(
            {
              ...
              address: {
                "@type": "PostalAddress",
                streetAddress:
                  "Raama associates, 1 A, Vinayaganagar, MCN Nagar Extension",
              ...
              sameAs: [
                "https://www.facebook.com/Honeyhivechennai/",
                "https://www.instagram.com/honeyhive_chennai/",
              ],
            },
            null,
            2
