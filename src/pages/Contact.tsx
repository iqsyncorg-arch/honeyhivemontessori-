        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-foreground mb-6">
              Connect with <span className="text-gradient">Honey Hive</span>
            </h1>
            <blockquote className="text-lg italic text-muted-foreground border-l-4 border-accent pl-4 py-2 mb-6 text-left">
              “The greatest gifts we can give our children are the roots of responsibility and the wings of independence.”
              <span className="block font-bold mt-2">— Dr. Maria Montessori</span>
            </blockquote>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {contactInfo.map((info, i) => (
              <motion.div
                ...
                className="bg-card p-6 rounded-2xl shadow-soft text-center border border-border/50"
              >
                <div className="w-14 h-14 mx-auto mb-4 bg-accent/10 rounded-2xl flex items-center justify-center text-accent">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <div className="bg-card p-8 rounded-3xl shadow-card border border-border/50 h-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="phone" type="tel" placeholder="+91 99529 00051" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="message">How can we help you?</Label>
                    <Textarea id="message" placeholder="Tell us about your child..." rows={5} required />
                  </div>
            ...
            >
              <div className="bg-card rounded-3xl shadow-card border border-border/50 overflow-hidden h-[400px]">
                <iframe
                  title="Honey Hive Montessori Location"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.750464645224!2d80.2312686!3d12.9237466!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525d02336365f5%3A0x6b3b55502f9c7a2b!2sHoney%20Hive%20Montessori%20House!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <div className="bg-primary p-8 rounded-3xl text-primary-foreground">
                <h3 className="text-xl font-heading font-bold mb-4">Follow Our Journey</h3>
                <div className="flex gap-4">
                  <a href="https://www.facebook.com/Honeyhivechennai/" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all">
                    <Facebook className="w-6 h-6" />
                  </a>
                  <a href="https://www.instagram.com/honeyhive_chennai/" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all">
            ...
            <div className="grid gap-4">
              {faqs.map((faq, i) => (
                <motion.div
                  ...
                  className="bg-card p-6 rounded-2xl shadow-sm border border-border/40"
                >
                  <h3 className="font-heading font-bold text-foreground mb-2 flex items-start">
                    <span className="text-accent mr-3">Q.</span> {faq.q}
                  </h3>
                  <div className="font-body text-sm text-muted-foreground pl-7 border-l-2 border-accent/20 ml-2">
                    {faq.a}
                  </div>
                </motion.div>
              ))}
